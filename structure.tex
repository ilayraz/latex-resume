...
\newcommand{\workposition}[7]{
  ...
  %Location
  \expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright #4} \\}
  % Job title
  \expandafter\ifstrequal\expandafter{#5}{}{}{{\raggedright\large\textit{\textbf{#5}}}}
  % Description
  \expandafter\ifstrequal\expandafter{#6}{}{}{\\[4pt]#6\\}
  % Bullet points
  \expandafter\ifstrequal\expandafter{#7}{}{}{\begin{itemize}#7\end{itemize}}
}
