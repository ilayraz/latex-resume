...
\makebox[\textwidth][s]{
  ...
  \hfill
  \raisebox{-1pt}{\small\faDesktop} \href{https://www.linkedin.com/ilayraz}{linkedin.com/ilayraz}
  \hfill
...
\section{Skills}
\begin{supertabular}{rl}
  \tableentry{Beginner}{Java, C}{space}

  \tableentry{Intermidiate}{C++, Git, Linux}{space}
